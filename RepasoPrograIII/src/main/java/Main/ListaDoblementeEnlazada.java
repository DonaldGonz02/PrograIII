...
public class ListaDoblementeEnlazada {
    ...
    public void insertarInicio(Data data) {
    ...
    public void insertarFinal(Data data) {
        Nodo nuevo = new Nodo(data);
        if (esVacia()) {
            cabeza = nuevo;
        } else {
    ...
    public Nodo buscarNumero(int dato) {
        ...
        while (buscado == null && iterador != null) {
            if (iterador.getData().getNumero() == dato) buscado = iterador;
    ...
    public void mostrar() {
        ...
        while (iterador != null) {
            System.out.print("[" + iterador.getData().getNumero() + "," + iterador.getData().getNombre() + "," + iterador.getData().getDireccion() + "] -> ");
            iterador = iterador.getSiguiente();
        }
